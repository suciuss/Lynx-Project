...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Create Terms and Conditions') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('createTerms') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="content"  class="form-control @error('content') is-invalid @enderror" name="content"  required autocomplete="email"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control col-md-6" style="padding-right: 12px; padding-left: 12px" name="publication_date">
                                        <option value="null">Not published</option>
